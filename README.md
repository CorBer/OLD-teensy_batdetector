...
-Menu expanded with <br>
     <tab>TE_speed : replay speed when using Auto_TimeExpansion (20 means 1/20th of original speed)<br>
     <tab>TE_low : lowest frequency to check for possible signalpeaks that will trigger the TimeExpansion<br>
